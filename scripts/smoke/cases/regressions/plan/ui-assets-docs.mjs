const uiAssetDocsPlan = [
    {
        name: 'runDataListPaginationRegression',
        label: 'data-list pagination regression'
    },
    {
        name: 'runDataListDomRegression',
        label: 'data-list DOM regression'
    },
    {
    ...
    {
        name: 'runProxyPolicyRegression',
        label: 'proxy-policy regression'
    },
    {
